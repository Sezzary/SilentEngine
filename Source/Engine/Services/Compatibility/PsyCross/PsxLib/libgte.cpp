...
#include "Engine/Services/Compatibility/PsyCross/PsxLib/inline_c.h"
#include "Engine/Services/Compatibility/PsyCross/PsxLib/gtereg.h"
#include "Engine/Services/Compatibility/PsyCross/PsxLib/gtemac.h"
#include "Engine/Services/Compatibility/PsyCross/PsxLib/ratan_tbl.h"
#include "Engine/Services/Compatibility/PsyCross/PsxLib/rcossin_tbl.h"
#include "Engine/Services/Compatibility/PsyCross/PsxLib/sqrt_tbl.h"
#include "Engine/Services/Compatibility/PsyCross/Gte.h"
...
void PushMatrix()
{
    ...
    {
        Log("Can't push matrix. Stack(max 20) is full.", LogLevel::Warning, LogMode::Debug);
    }
}
...
void PopMatrix()
{
    ...
    {
        Log("Can't pop matrix. Stack is empty.", LogLevel::Warning, LogMode::Debug);
    }
}
...
{
    // FIXME: Might be wrong as `RTV0` can be insufficient.
    gte_ldv0(&m0->m[0]);
    gte_rtv0();
    gte_stsv(&m0->m[0]);
